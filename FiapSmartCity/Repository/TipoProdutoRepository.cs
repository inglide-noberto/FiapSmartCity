    ...
    public class TipoProdutoRepository
    {
        public IList<TipoProduto> Listar()
        {
            ...
            var connectionString = new ConfigurationBuilder()
                ...
                .Build()
                .GetConnectionString("FiapSmartCityConnection");
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                while (dataReader.Read())
                {
                    ...
                    tipoProduto.IdTipo = Convert.ToInt32(dataReader["IDTIPO"]);
                    tipoProduto.DescricaoTipo = dataReader["DESCRICAOTIPO"].ToString();
                    tipoProduto.Comercializado = dataReader["COMERCIALIZADO"].Equals("1");
